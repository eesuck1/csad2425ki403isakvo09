...
MAN_VS_MAN_PACKET = bytes([0xBB for _ in range(RECEIVE_BUFFER_LENGTH)])
MAN_VS_AI_PACKET = bytes([0xCC for _ in range(RECEIVE_BUFFER_LENGTH)])
AI_VS_AI_PACKET = bytes([0xDD for _ in range(RECEIVE_BUFFER_LENGTH)])
RESET_PACKET = bytes([0x99 for _ in range(RECEIVE_BUFFER_LENGTH)])
